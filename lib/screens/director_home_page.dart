                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MenuCard(
                        ...
                        backgroundColor: const Color(0xFF0A2035),
                        borderColor: const Color(0xFF1B5278),
                        titleColor: const Color(0xFF4FC3F7),
                        subtitleColor: const Color(0xFF8CAFC4),
                      ...
                      MenuCard(
                        ...
                        backgroundColor: const Color(0xFF231A08),
                        borderColor: const Color(0xFF6B5526),
                        titleColor: const Color(0xFFFFB74D),
                        subtitleColor: const Color(0xFFB5A48A),
                      ...
                      MenuCard(
                        ...
                        borderColor: const Color(0xFF6B2A2A),
                        titleColor: const Color(0xFFEF9A9A),
                        subtitleColor: const Color(0xFFB5908A),
